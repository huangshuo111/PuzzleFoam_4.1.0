...
public class FingerEventsSamplePart1 : SampleBase
{
	...
	private void OnFingerUp(FingerUpEvent e)
	{
		...
		Debug.Log(string.Concat("Finger was lifted up on ", (!e.Selection) ? "<nothing>" : e.Selection.name, " at ", finger.Position, " and moved ", finger.DistanceFromStart.ToString("N0"), " pixels from its initial position at ", finger.StartPosition, ". It was held down for ", e.TimeHeldDown, " seconds"));
	}
